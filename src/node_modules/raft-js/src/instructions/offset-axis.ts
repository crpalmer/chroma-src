...
export interface OffsetAxisInstructionParams extends RaftInstructionParams {
    x?: number,
    y?: number,
    z?: number
}

export default class OffsetAxisInstruction extends RaftInstruction {

    readonly x: number;
    readonly y: number;
    readonly z: number;

    constructor (params: OffsetAxisInstructionParams) {
