...
export interface SetMaxFeedrateInstructionParams extends RaftInstructionParams {
    x?: number,
    y?: number,
    z?: number,
    extrusion?: number
...
export default class SetMaxFeedrateInstruction extends RaftInstruction {
    ...
    constructor (params: SetMaxFeedrateInstructionParams) {
