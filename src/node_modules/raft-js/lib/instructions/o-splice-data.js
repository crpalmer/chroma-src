...
class OSpliceDataInstruction extends oem_1.default {
    constructor(params) {
        if (!validation_1.validateNumber(params.drive) || params.drive < 0) {
            throw new invalid_argument_1.default("Invalid drive number '" + params.drive + "' supplied as argument");
        }
...
exports.default = OSpliceDataInstruction;
//# sourceMappingURL=o-splice-data.js.map